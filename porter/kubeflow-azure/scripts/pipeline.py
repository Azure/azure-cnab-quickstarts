...
def tacosandburritos_train(
  ...
  operations['preprocess'] = dsl.ContainerOp(
    name='preprocess',
    image=registry + '.azurecr.io/preprocess:' + version,
    command=['python'],
    arguments=[
      '/scripts/data.py',
  ...
  operations['training'] = dsl.ContainerOp(
    name='training',
    image=registry + '.azurecr.io/training:' + version,
    command=['python'],
    arguments=[
      '/scripts/train.py',
      '--base_path', persistent_volume_path,
  ...
  operations['register'] = dsl.ContainerOp(
    name='register',
    image=registry + '.azurecr.io/register:' + version,
    command=['python'],
    arguments=[
      '/scripts/register.py',
      '--base_path', persistent_volume_path,
  ...
  operations['profile'] = dsl.ContainerOp(
    name='profile',
    image=registry + '.azurecr.io/profile:' + version,
    command=['sh'],
    arguments=[
      '/scripts/profile.sh',
      '-n', profile_name,
  ...
  operations['deploy'] = dsl.ContainerOp(
    name='deploy',
    image=registry + '.azurecr.io/deploy:' + version,
    command=['sh'],
    arguments=[
      '/scripts/deploy.sh',
      '-n', model_name,
